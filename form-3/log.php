<?php
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $sql = "SELECT STUDENT_ID FROM studentlogintest WHERE STUDENT_NAME = '$myusername' AND PASSWORD = '$mypassword'";
	                            ...
	                            <div class="form-bottom">
				                    <form role="form" action="insert.php" method="post" class="registration-form">
				                    	<div class="form-group">
				                        	...
				                        	<input type="text" name="form-reg-no" placeholder="Registration No..." class="form-first-name form-control" id="form-first-name">
				                        </div>
				                        <div class="form-group">
										...
										<div class="form-group">
				                        	<label class="sr-only" for="form-email">SEMESTER AND BRANCH</label>
				                        	<input type="text" name="form-sem" placeholder="Semester..." class="form-email form-control" id="form-sem">
				                        </div>
										<div class="form-group">
				                        	<label class="sr-only" for="form-email">BRANCH</label>
				                        	<input type="text" name="form-branch" placeholder="Branch..." class="form-email form-control" id="form-sem">
				                        </div>
				                        <div class="form-group">
